        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text('Günlük Soru', style: TextStyle(fontSize: 18, color: Colors.white70)),
                ...
                child: Center(
                  child: SectionCard(
                    child: Column(
                      ...
                      children: [
                        const Icon(LucideIcons.sparkles, size: 22, color: Color(0xFFC8A96E)),
                        const SizedBox(height: 16),
                          questionAsync.when(
                          ...
                          error: (e, _) => const Text(
                            ...
                            style: TextStyle(fontSize: 24, height: 1.45, fontWeight: FontWeight.w600),
                          ),
                          data: (question) => Text(
                            question,
                            textAlign: TextAlign.center,
              ...
              PrimaryButton(
                ...
                onPressed: () => Navigator.pushNamed(context, EntryScreen.routeName),
              ),
              const SizedBox(height: 14),
              PrimaryButton(
                label: 'Takvim',
